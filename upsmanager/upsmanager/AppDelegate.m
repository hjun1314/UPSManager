...
#import "UPSNacVC.h"
#import "UPSLoginVC.h"
#define JpushAppkey         @"a0b7cba5276636c9c67aebba"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UPSNacVC *nav = [[UPSNacVC alloc]initWithRootViewController:login];
    self.window.rootViewController = nav;
    [self.window makeKeyAndVisible];
    [AMapServices sharedServices].apiKey = @"7db68ffee828dbf923ce339cc1fef7d3";
